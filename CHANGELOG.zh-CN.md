...
- 可以用在 DSH 0.1.7-rc.2 上，以前能用的版本仍然能用。
- 支持的 DSH 版本为 0.1.0-rc.8、0.1.1-rc.2、0.1.2-rc.1、0.1.5-rc.1、0.1.5-rc.2、0.1.7-rc.1、0.1.7-rc.2。

## 1.0.4 - 2026-09-24

- 归档会话这一页跟随宿主配色。深色下主色保持宿主的信息蓝，菜单比输入框亮一级。
- 支持的 DSH 版本为 0.1.0-rc.8、0.1.1-rc.2、0.1.2-rc.1、0.1.5-rc.1、0.1.5-rc.2、0.1.7-rc.1。

## 1.0.3 - 2026-09-23

- 可以用在 DSH 0.1.7-alpha.1 上，以前能用的版本仍然能用。
- 归档会话这一页更好找：搜索、项目、收藏、排序和日期分成两行。已收藏的星标是黄色。
- 归档一个还在进行的会话时，会先问你要不要停下来，再归档。
- 会话列表本身有菜单时，删除加在那个菜单里，不再换成另一套列表。
- 批量操作进行时，不能在「已归档」和「未归档」之间切换。
