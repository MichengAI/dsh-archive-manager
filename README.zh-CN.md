...
# DSH Archive Manager
  ...
  **在 DeepSeek Harness 中安全管理已归档会话**
  ...
  [![DSH 支持至 0.1.7-rc.2](https://img.shields.io/badge/DSH-%E6%94%AF%E6%8C%81%E8%87%B3%200.1.7--rc.2-2563eb.svg)](#前置条件)
</div>
...
- 当前支持 DSH `0.1.0-rc.8`、`0.1.1-rc.2`、`0.1.2-rc.1`、`0.1.5-rc.1`、`0.1.5-rc.2`、`0.1.7-rc.1`、`0.1.7-rc.2`；其他版本暂未纳入支持范围。
