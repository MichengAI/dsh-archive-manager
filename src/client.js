		...
		function ArchivedSessionsSection({ archiveSessions, sessionStore, workspaceStore, unarchiveSession, deleteSession, unarchiveSessions, deleteArchivedSessions, archivedSessionMetadata, openConversation, viewState, close, t }) {
			...
			return (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [(0, react_jsx_runtime.jsx)("style", { children: ARCHIVE_TABS_CSS + ARCHIVE_SETTINGS_CSS + ARCHIVE_SETTINGS_BATCH_CSS + ARCHIVE_SETTINGS_EXTERNAL_LINK_CSS + ARCHIVE_SETTINGS_SELECTION_CSS + ARCHIVE_SETTINGS_DELETE_CONFIRM_CSS + ARCHIVE_WORKSPACE_CONFIRM_CSS }), (0, react_jsx_runtime.jsxs)("div", {
					...
					className: "dsham_archiveTabs", role: "tablist", "aria-label": t("archives.title"),
					children: ["archived", "unarchived"].map((tab) => (0, react_jsx_runtime.jsx)("button", {
						type: "button", role: "tab", className: "dsham_archiveTab", id: "dsham-tab-" + tab, "aria-controls": "dsham-archive-panel", "aria-selected": archiveTab === tab,
						tabIndex: archiveTab === tab ? 0 : -1, disabled: busy || unarchivingSessionIds.size > 0,
					...
					return (0, react_jsx_runtime.jsxs)("section", {
						...
						children: [(0, react_jsx_runtime.jsxs)("div", {
							...
							children: [(0, react_jsx_runtime.jsxs)("h3", { className: "dsham_settingsGroupTitle", children: [(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconFolderOpenOutline16, {}), group.title] }), (0, react_jsx_runtime.jsxs)("div", { className: "dsham_settingsGroupMeta", children: [(0, react_jsx_runtime.jsx)("span", { className: "dsham_settingsCount", children: t("archives.sessionCount", { n: count }) }), (0, react_jsx_runtime.jsx)(ArchivedGroupActions, { group, busy, onArchive: isArchived ? undefined : () => requestArchive(groupSessionIds, group), onRestore: () => onBatchUnarchive(target), onDelete: () => setDeleteTarget({ kind: "batch", target, title: group.title, count }), t })] })]
						}), (0, react_jsx_runtime.jsx)("div", {
