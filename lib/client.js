window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const ARCHIVE_SETTINGS_CSS = ".dsham_settings{color:var(--dsw-alias-label-primary);max-width:680px}.dsham_settings h2{margin:0;font-size:18px;font-weight:650}.dsham_settingsIntro{margin:6px 0 18px;color:var(--dsw-alias-label-secondary);font-size:12px}.dsham_settingsGroup{margin:0 0 18px}.dsham_settingsGroupTitle{margin:0 0 8px;color:var(--dsw-alias-label-secondary);font-size:13px;font-weight:600}.dsham_settingsList{overflow:hidden;border:1px solid var(--dsw-alias-border-l2);border-radius:12px}.dsham_settingsRow{display:flex;align-items:center;gap:12px;min-height:62px;padding:10px 12px;border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-button-elevated-fill)}.dsham_settingsRow:last-child{border-bottom:0}.dsham_settingsContent{min-width:0;flex:1}.dsham_settingsTitle{overflow:hidden;color:var(--dsw-alias-label-primary);font-size:14px;font-weight:600;text-overflow:ellipsis;white-space:nowrap}.dsham_settingsMeta{margin-top:3px;color:var(--dsw-alias-label-tertiary);font-size:12px}.dsham_settingsActions{display:flex;align-items:center;gap:8px}.dsham_settingsAction{height:30px;padding:0 10px;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-button-elevated-fill);border:1px solid var(--dsw-alias-border-l2);border-radius:8px;cursor:pointer;font-size:12px;font-weight:600}.dsham_settingsAction:hover{background:var(--dsw-alias-interactive-bg-hover)}.dsham_settingsDelete{display:flex;align-items:center;justify-content:center;width:30px;height:30px;color:var(--dsw-alias-label-tertiary);background:transparent;border:0;border-radius:8px;cursor:pointer}.dsham_settingsDelete:hover{color:var(--dsw-alias-state-error-primary);background:var(--dsw-alias-interactive-bg-hover)}.dsham_settingsEmpty{padding:20px 8px;color:var(--dsw-alias-label-secondary);text-align:center}.dsham_settingsError{margin-top:10px;color:var(--dsw-alias-state-error-primary);font-size:12px}";
		...
		function ArchivedSessionsSection({ sessionStore, workspaceStore, unarchiveSession, deleteSession, t }) {
			...
			return (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [(0, react_jsx_runtime.jsx)("style", { children: ARCHIVE_SETTINGS_CSS }), (0, react_jsx_runtime.jsx)("h2", { children: t("archives.title") }), (0, react_jsx_runtime.jsx)("p", { className: "dsham_settingsIntro", children: t("archives.description") }), groups.length === 0 ? (0, react_jsx_runtime.jsx)("div", { className: "dsham_settingsEmpty", children: t("archives.empty") }) : groups.map((group) => (0, react_jsx_runtime.jsxs)("section", {
					className: "dsham_settingsGroup",
					children: [(0, react_jsx_runtime.jsx)("h3", { className: "dsham_settingsGroupTitle", children: group.title }), (0, react_jsx_runtime.jsx)("div", {
						...
						children: group.sessions.map((session) => (0, react_jsx_runtime.jsxs)("article", {
							...
							children: [(0, react_jsx_runtime.jsxs)("div", { className: "dsham_settingsContent", children: [(0, react_jsx_runtime.jsx)("div", { className: "dsham_settingsTitle", children: displayTitle(session, t) }), (0, react_jsx_runtime.jsx)("div", { className: "dsham_settingsMeta", children: timeLabel(session.updatedAt, Date.now(), t) })] }), (0, react_jsx_runtime.jsxs)("div", {
		...
		*/
		function applyWorkspaceBrowser(ctx) {
			...
			ctx.slots.inject("settings.section", () => ctx.slots.register({
				...
				order: 18,
				label: () => ctx.locale.bind(NS)("archives.title"),
				locale: NS,
				inject: () => ({
