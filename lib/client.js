window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const ARCHIVE_SETTINGS_LAYOUT_OVERRIDE = ".dsham_settings{margin:24px auto 80px!important}@media(max-width:720px){.dsham_settings{margin:16px auto 48px!important}}";
