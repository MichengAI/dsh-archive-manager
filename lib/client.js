window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		/** 设置页项目筛选：自定义菜单，避免原生 select 弹出系统浅色下拉。 */
