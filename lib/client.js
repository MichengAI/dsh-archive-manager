	...
	factory: (require) => {
		...
		*/
		...
		const zh = {
			...
			"archives.viewProject": "查看项目",
			"archives.feedback": "意见反馈",
		...
		const en = {
			...
			"archives.viewProject": "View project",
			"archives.feedback": "Send feedback",
