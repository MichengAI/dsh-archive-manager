  ...
  function createDiscoveryTools(React) {
    ...
    function DiscoveryFilters({ t, from, to, onFrom, onTo, invalid, onClear }) {
      ...
      return h(
        ...
        h(
          "summary",
          { title: range, "aria-label": t("discovery.date") + (active ? "\uFF1A" + range : ""), "data-active": active },
          h(
            "svg",
            ...
            return (0, react_jsx_runtime.jsxs)("section", {
              ...
              children: [(0, react_jsx_runtime.jsxs)("div", {
                ...
                children: [(0, react_jsx_runtime.jsx)("h3", { className: "dsham_settingsGroupTitle", children: (0, react_jsx_runtime.jsxs)("button", { type: "button", className: "dsham_groupToggle", "aria-expanded": !collapsedGroups.has(group.key), "aria-controls": "dsham-group-" + encodeURIComponent(group.key), onClick: () => setCollapsedGroups((previous) => {
                  ...
                  return next;
                }), children: [(0, react_jsx_runtime.jsx)(collapsedGroups.has(group.key) ? _deepseek_ai_dsh_client_ui_primitives.IconChevronRightOutline14 : _deepseek_ai_dsh_client_ui_primitives.IconChevronDownOutline14, {}), (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconFolderOpenOutline16, {}), (0, react_jsx_runtime.jsx)("span", { children: group.title })] }) }), (0, react_jsx_runtime.jsxs)("div", { className: "dsham_settingsGroupMeta", children: [(0, react_jsx_runtime.jsx)("span", { className: "dsham_settingsCount", children: t("archives.sessionCount", { n: count }) }), (0, react_jsx_runtime.jsx)(ArchivedGroupActions, { group, busy, onArchive: isArchived ? void 0 : () => requestArchive(groupSessionIds, group), onRestore: () => onBatchUnarchive(target), onDelete: () => setDeleteTarget({ kind: "batch", target, title: group.title, count }), t })] })]
              }), (0, react_jsx_runtime.jsx)("div", {
                ...
                children: !collapsedGroups.has(group.key) && group.sessions.map((session) => (0, react_jsx_runtime.jsxs)("article", {
                  ...
                  children: [
                    ...
                    (0, react_jsx_runtime.jsxs)("div", { className: "dsham_settingsContent", children: [
                      ...
                      contentMatches.has(session.id) && react.createElement("button", { type: "button", className: "dsham_settingsSnippet", disabled: busy, title: t("discovery.preview"), onClick: () => preview.open(session, query) }, react.createElement(HighlightedText, { text: contentMatches.get(session.id).snippet, query }))
                    ] }),
                    (0, react_jsx_runtime.jsxs)("div", { className: "dsham_settingsActions", children: [
                      ...
                      isArchived && (0, react_jsx_runtime.jsx)(ArchivedSessionMenu, { busy: busy || unarchivingSessionIds.has(session.id), t, title: displayTitle(session, t), onPreview: previewArchivedSession ? () => preview.open(session, query) : void 0, onRestoreOpen: () => viewConversation(session, true), onDelete: () => setDeleteTarget({ kind: "session", session }) })
                    ] })
                  ]
                }, session.id))
              })]
