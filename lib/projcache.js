...
/**
 * Seed the compatibility domain without ever opening alpha.2's unsafe
 * per-record source while a v3 whole-file cache is present. Imports are
 * add-only: a newer compatibility-domain checkpoint always wins, and a
 * partially completed import resumes on the next startup.
 */
